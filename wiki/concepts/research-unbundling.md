...
- **Three permissible routes; no others (COBS 2.3B.3R).** (1) Direct payment from the firm's own P&L resources; (2) RPA funded by a separate client charge (COBS 2.3B.4R); (3) joint payments for research and execution with the research element separately identified (COBS 2.3B.25R). The firm must unbundle: it must not pay for research through undifferentiated execution commissions. Research received outside these three routes is an inducement under COBS 2.3A and cannot be rehabilitated by disclosure. A breach of the research unbundling obligation is also a breach of COBS 2.3A — and under COBS 2.3A.7E, a breach of the inducements rules is automatically a breach of the client's best interests rule under COBS 2.1.1R, with no separate analysis required.
