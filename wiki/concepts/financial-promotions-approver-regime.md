...
Under **FSMA 2000 s.21**, an unauthorised person may not communicate a financial promotion unless its content has been approved by an authorised person. This is the "financial promotion restriction" — a criminal offence for the unauthorised person, and a civil liability trigger for the firm that approves non-compliant content (FSMA s.138D).

COBS 4.10 sets out the FCA's conduct obligations for authorised firms acting as approvers. These are separate from the s.21 legal restriction itself: a firm can satisfy s.21 but still breach COBS 4.10.
...
- **Three distinct obligations** under COBS 4.10: (1) pre-approval COBS 4 compliance confirmation; (2) ongoing monitoring with a withdrawal power; (3) quarterly written attestation from the unauthorised person that the promotion has not been materially changed. All three must be in place — not just the sign-off.
- **Competence is a hard Rule** (COBS 4.10.9AR): the individuals approving must have expertise specific to the product type. Generic compliance sign-off is insufficient for cryptoassets, pension transfers, structured products, or FIIAs.
- **The FCA Gateway applies from January 2024**: firms need specific FCA permission to approve promotions for unauthorised persons. Cryptoasset approvals require additional 7-day prior notification and quarterly FCA attestations under PS23/6.
- **Ongoing monitoring is not optional**: once approved, the firm has a continuing obligation to detect if the promotion ceases to comply and to withdraw approval if it does.
- **Record keeping tiers**: pension transfer indefinitely; MiFID/life policy 5 years; other retail 3 years. Attestations must be retained for the same period.
