...
## 2026-05-26 ingest | 31 CFR Part 1022 — Bank Secrecy Act Rules for Money Services Businesses

Source: `raw/us/31 CFR Part 1022 (up to date as of 5-21-2026).pdf` (FinCEN official text, 13pp)

Pages created:
- `wiki/summaries/bsa-rules-for-msbs.md` — Full summary: Subpart B AML programme §1022.210 (4 elements, risk-commensurate, no board approval, agent allocation with sole-principal liability, prepaid access customer ID embedded as fifth programme element); MSB SAR §1022.320 (≥$2,000 threshold; four filing grounds including "use of MSB to facilitate criminal activity"; FinCEN Hotline for terrorist activity); MSB registration §1022.380 (180 days; biennial; ownership/equity/agent triggers; $5,000/day civil penalty; 18 USC 1960); dealer in foreign exchange records §1022.410; prepaid access records §1022.420; Subparts E–F cross-reference Part 1010
- `wiki/concepts/bsa-msb-sar.md` — MSB SAR: $2,000 threshold; $5,000 for money order/traveler's check issuers; four filing grounds (fourth ground unique to MSBs); 30/60-day timeline; immediate telephone notification for ongoing schemes; FinCEN Hotline 1-866-556-3974; absolute confidentiality; subpoena refusal obligation; safe harbour; full comparison table MSB vs bank SAR
- `wiki/concepts/bsa-msb-registration.md` — MSB registration: 180-day window; pure agents and USPS exempt; biennial re-registration; three triggering events (ownership change/>10% equity/>50% agent increase); annual agent list obligation; $5,000/day civil penalty; 18 USC 1960 criminal liability; distinction from BOI reporting under §1010.380
- `wiki/concepts/bsa-prepaid-access.md` — Prepaid access: customer ID embedded in AML programme (name/DOB/address/ID number; >$10K/day verification threshold); provider vs seller obligations; 5-year retention from last use; §1022.420 transactional records (activation, loads, reloads, purchases, withdrawals, transfers); comparison table prepaid access vs bank CIP

No contradictions with existing wiki pages. MSB SAR (§1022.320) is the MSB-specific complement to bank SAR (§1020.320) — different thresholds and an additional filing ground, but same structural framework (30/60-day timeline, confidentiality, safe harbour). Prepaid access customer ID (§1022.210(b)(5)) is consistent with and complements the general CDD rule (§1010.230) and bank CIP (§1020.220) — same four data fields, different regulatory hooks and verification thresholds.
