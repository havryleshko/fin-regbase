...
| [concepts/consumer-duty-products-services.md](concepts/consumer-duty-products-services.md) | Products & Services outcome: target market, fit-for-purpose lifecycle obligations, manufacturer/distributor split; PROD equivalence | 1 |
| [concepts/consumer-duty-price-value.md](concepts/consumer-duty-price-value.md) | Price & Value outcome: fair value assessment, distribution chain responsibilities, closed book application, COLL/PROD equivalence | 1 |
| [concepts/consumer-duty-consumer-understanding.md](concepts/consumer-duty-consumer-understanding.md) | Consumer Understanding outcome: communications must demonstrably support effective decisions; testing obligation; replaces P7 "clear, fair, not misleading" | 1 |
