---
title: "FCA Supervisory Questions — Consumer Duty (per Outcome)"
jurisdiction: UK
regulator: FCA
...
sources:
  ...
  - "FCA FG22/5 Ch.7 (Key questions for firms)"
  - "FCA FG22/5 Ch.8 (Key questions for firms)"
  - "FCA FG22/5 Ch.9 (Key questions for firms)"
  - "FCA FG22/5 Ch.10 (Key questions for firms)"
...
FG22/5 sets out, at the end of each outcome chapter and the governance chapter, examples of the questions firms can expect to be asked in their interactions with the FCA in relation to that outcome. These questions are also intended for use by the board-level Duty champion and the Chair to guide board-level discussions.

This page collects all five sets of supervisory questions in one place for reference. The questions are drawn verbatim from FG22/5.

These questions are not an exhaustive checklist — they are the FCA's signalled supervisory priorities for each outcome. A firm that cannot answer these questions clearly and with supporting evidence is likely to face scrutiny. **(FG22/5 §6, §7, §8, §9, §10 — "Key questions for firms" sections)**

---

## 1. Products and Services Outcome

**(FG22/5 Ch.6 — Key questions for firms)**
...
**(FG22/5 Ch.7 — Key questions for firms)**
...
**(FG22/5 Ch.8 — Key questions for firms)**
...
**(FG22/5 Ch.9 — Key questions for firms)**
...
**(FG22/5 Ch.10 — Key questions for firms)**
...
- These questions are the FCA's signalled supervisory agenda for Consumer Duty — treat them as a compliance checklist as well as exam questions.
- Two cross-cutting themes appear across all five sets: (i) the quality of ongoing monitoring data and MI; and (ii) the treatment of vulnerable customers. Every outcome has at least one vulnerability-focused question.
- The consumer support questions include an explicit "at least as easy to exit as enter" test — this is a direct, evidence-based question, not a general probe.
- The governance section distinguishes between culture questions (purpose, leadership, staff challenge) and customer outcome questions (data, monitoring, root cause, accountability). Both must be answered.
- The board report required annually under FG22/5 §10.12 should directly address the customer outcome governance questions.
