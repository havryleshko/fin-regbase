      ...
      <div className="rounded-2xl border border-border bg-surface p-8 md:p-10">
        ...
        <div className="mt-8 flex flex-col gap-3 sm:flex-row">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center justify-center rounded-md border border-border bg-background px-5 py-3 text-sm font-semibold text-text-primary hover:bg-white"
          >
            View on GitHub
          </a>
        </div>
        <div className="mt-8 text-sm text-text-secondary">
          ...
          ·{" "}
          <a
            href="https://github.com/ohavryleshko/fin-regbase/blob/main/LICENSE"
            target="_blank"
            rel="noreferrer"
            className="hover:text-text-primary"
          >
